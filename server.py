...
texts = {"help": ["Задайте мне вопрос \"Где поесть?\", и я отвечу где можно перекусить или "
                  ...
                  "хотя вы можете спросить какие праздники будут в следующие, например, 4 дня.",
                  "Вы можете спросить у меня \"Где мне поесть?\", я вам отвечу куда вы можете сходить,\n"
                  "Задайте вопрос \"Что приготовить\", и я расскажу вам какой-нибудь рецепт,\n"
